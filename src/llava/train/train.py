...
from src.llava.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
from torch.utils.data import Dataset
from src.llava.train.llava_trainer import LLaVATrainer

from src.llava import conversation as conversation_lib
from src.llava.model import *
from src.llava.mm_utils import process_anyres_image, tokenizer_image_token
from src.llava.load_utils import get_model, get_tokenizer

from PIL import Image
from src.llava.utils import get_logger
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    llm_backbone: str = field(default=None) # deprecated: use 'model_architecture' instead
...
def preprocess(
    ...
    if conversation_lib.default_conversation.version == "llama_3_1_reasoning":
        return preprocess_llama_3_1_reasoning(sources, tokenizer, has_image=has_image)
    if conversation_lib.default_conversation.version == "phi_4":
        return preprocess_phi_4(sources, tokenizer, has_image=has_image)
...
def train(attn_implementation=None):
    ...
    tokenizer = get_tokenizer(model_args, model, training_args)
